...
diplomacy = {
	...
	TWS_FULFILLED_SPEED = 0.0, -- Ticking War Score grows up with this speed daily once CB is fulfilled
	TWS_NOT_FULFILLED_SPEED = 0.0, -- Ticking War Score falls down when CB is not fulfilled (or after grace period)
